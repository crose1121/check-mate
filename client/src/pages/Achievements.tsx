...
export default function Achievements() {
  ...
  const currentTierName = ACHIEVEMENT_TIERS[unlockedTierIndex].name;
  ...
  return (
    <div className="achievements-container">
      <div className="achievements-header">
        <div className="achievements-heading">
          ...
          <p className="achievements-description">
            Complete tasks to unlock trophies and climb the ranks. Keep going — every task counts!
          </p>
        </div>
        <div className="achievements-stats">
          <span className="achievements-current-tier">✦ {currentTierName}</span>
          <span className="achievements-task-count">{completedTasks} tasks completed</span>
        </div>
      </div>
      ...
      <div className="trophy-grid" role="region" aria-label="Trophy tiers">
        {ACHIEVEMENT_TIERS.map((tier) => {
          ...
          return (
            <div
              className={`trophy-item tier-${tier.tier} ${isUnlocked ? "unlocked" : "locked"} ${celebratingTierName === tier.name ? "trophy-item-unlock" : ""}`}
              key={tier.name}
            >
              {isUnlocked ? (
                <span
              ...
              <p className="trophy-unlock-text">
                {isUnlocked
                  ? "Unlocked"
                  : `Complete ${tier.requiredTasks} tasks`}
              </p>
            </div>
          );
        })}
